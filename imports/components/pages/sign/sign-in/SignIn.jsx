      ...
      <div className="signin">
        <div className="card card_login">
          <div className="login-form">
            ...
            <div className="login-item login-item-forgot"> <a className="link-default" href="/forgot-pass">Забыли пароль </a>или <a className="link-default" href="#">не пришло письмо?</a></div>
          </div>
        </div>
